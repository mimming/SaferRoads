...
var e, t;
if ($B.isStatic() || "undefined" != typeof data) return t = new Bobcat.SocialMediaConfig({
...
$B.PageAE.trackPageEvent(), $B.PageAE.setSocialShareTracking()), $B.isStatic()) ? void 0 :Bobcat.PageAE.setInternalTracking();
});
}).call(this);