...
public class MotionEventGenerator {
     ...
     * a stream of position events. This must be obtained from {@link android.os.SystemClock#uptimeMillis()}.
     * @param eventTime The time (in ms) when this specific event was generated.  This
     * must be obtained from {@link android.os.SystemClock#uptimeMillis()}.
